...
public class EmailService {
    ...
    public void sendCreateEmail(PessoaEntity pessoaEntity) {
        ...
        try {
            ...
            mimeMessageHelper.setText(createByTemplate(pessoaEntity.getIdPessoa(), pessoaEntity.getNome()), true);
    ...
    public void sendCreateEnderecoEmail(PessoaEntity pessoa, EnderecoEntity enderecoEntity) {
        ...
        try {
            ...
            mimeMessageHelper.setText(enderecoCreateByTemplate(pessoa.getNome(), enderecoEntity.getIdEndereco()), true);
    ...
    public void sendUpdateEnderecoEmail(PessoaEntity pessoa, EnderecoEntity enderecoEntity) {
        ...
        try {
            ...
            mimeMessageHelper.setText(enderecoUpdateByTemplate(pessoa.getNome(), enderecoEntity.getIdEndereco()), true);
    ...
    public void sendRemoveEnderecoEmail(PessoaDTO pessoa, EnderecoEntity enderecoEntity) {
        ...
        try {
            ...
            mimeMessageHelper.setText(enderecoRemoveByTemplate(pessoa.getNome(), enderecoEntity.getIdEndereco()), true);
